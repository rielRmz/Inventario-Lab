<!-- Modal -->
<form action="{{ route('details.equipoSoft.destroy', $equipoSoft) }}" method="POST" enctype="multipart/form-data">
    {{ method_field('delete') }}
    {{ csrf_field() }}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Esta seguro de eliminar el registro seleccionado {{ $equipoSoft->id }}.
                </div>
